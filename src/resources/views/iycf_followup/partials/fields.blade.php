						...
						<div class="form-group row">
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="type_of_feeding" class="form-control">
                                    ...
                                    <option value="Breastmilk + Infant formula" {{ (isset($iycf_followup) && $iycf_followup->type_of_feeding == 'Breastmilk + Infant formula') ? ' selected' : '' }}>Breastmilk + Infant formula</option>
