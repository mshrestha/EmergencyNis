            ...
            <div class="col-lg-6">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{ route('facility.store') }}" class="form-horizontal" method="post"
                            ...
                            <div class="form-group"><label class="col-sm-3 control-label">status</label>
                                <div class="col-sm-9">
                                    <select name="status" class="form-control" required>
                                        <option value="Closed" {{ (isset($facility) && $facility->status == 'Closed') ? ' selected' : '' }}>
                                            Closed
                                        </option>
                            ...
                            <div class="form-group"><label class="col-sm-3 control-label">Latitude</label>
                                <div class="col-sm-9"><input type="text" name="latitude" class="form-control"
                                                             placeholder="Latitude" required
                                                             value="{{ isset($facility) ? $facility->latitude : '' }}">
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Longitude</label>
                                <div class="col-sm-9"><input type="text" name="longitude" class="form-control"
                                                             placeholder="Longitude" required
                                                             value="{{ isset($facility) ? $facility->longitude : '' }}">
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Service type</label>
                                <div class="col-sm-9">
                                    ...
                                    <select name="service[]" id="service"
                                            class="form-control input-circle show-tick selectpicker"
                                            data-live-search="true" multiple required>
                                        @foreach($services as $service)
                                            <option value="{{ $service->id }}" {{ (isset($facility) && $facility->service_id == $service->id) ? ' selected' : '' }}>{{ $service->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-3 control-label">Facility reg</label>
                                <div class="col-sm-9"><input type="text" name="facility_reg" class="form-control"
                                                             placeholder="Facility reg"
                                                             required
                                                             value="{{ isset($facility) ? $facility->facility_reg : '' }}">
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Community reg</label>
                                <div class="col-sm-9"><input type="text" name="community_reg" class="form-control"
                                                             placeholder="Community reg"
                                                             required
                                                             value="{{ isset($facility) ? $facility->community_reg : '' }}">
                                </div>
                            </div>
