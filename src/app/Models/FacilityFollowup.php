...
class FacilityFollowup extends Model
{
    ...
    protected $fillable = [
    	'sync_id', 'sync_status', 'facility_id', 'children_id', 'refered_by', 'referal_slip_no', 'date', 'next_visit_date',
        'age', 'attandance', 'muac', 'weight', 'height', 'wfh_z_score', 'oedema', 'medical_history_diarrhoea', 'medical_history_vomiting',
        'medical_history_fever', 'medical_history_cough', 'medical_history_others', 'medical_history_others_detail', 'temperature',
        'respiratory_rate', 'sign_of_dehydration', 'pneumonia', 'skin_changes', 'pale_conjunctiva', 'presence_of_appetite',
        'new_admission', 'readmission', 'transfer_in', 'return_from', 'antibiotic', 'albendazole', 'no_of_rutf', 'no_of_rusf',
        ...
        'outcome','medical_complecation','home_visit','discharge_muac','comments','planed_date'
