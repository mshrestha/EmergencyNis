		...
		<div class="form-group" id="data_1"><label class="col-sm-3 control-label">Next visit date</label>
			<div class="col-sm-9">
				<div class="input-group date">
					...
					<input type="date" name="next_visit_date" class="form-control" value="{{ isset($community_followup) ? $community_followup->next_visit_date : '' }}" style="width:200px !important" required>
				</div>
			</div>
		</div>
...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<select name="no_of_food_groups" class="form-control" required>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<select name="quantity_of_food" class="form-control" required>
	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="nutritional_status" class="form-control" required>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="refered_to_facility" class="form-control" required>
	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="distribution_mnp_sachet" class="form-control" placeholder="Distribution of MNP Sachet" value="{{ isset($community_followup) ? $community_followup->distribution_mnp_sachet : '' }}" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">Vitamin A</label>
				<div class="col-sm-9">
					<input type="text" name="vitamin_a" class="form-control" placeholder="Vitamin A" value="{{ isset($community_followup) ? $community_followup->vitamin_a : '' }}" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">Deworming</label>
				<div class="col-sm-9">
					<input type="text" name="deworming" class="form-control" placeholder="Deworming" value="{{ isset($community_followup) ? $community_followup->deworming : '' }}" required>
				</div>
			</div>
		</div>
	</div>
