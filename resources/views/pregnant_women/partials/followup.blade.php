					...
					<div class="ibox-content">
						<div class="form-group row" >
							<div class="col-md-8">
								...
								<input type="date" name="plan_date" class="form-control" value="{{ isset($pregnant_followup) ? $pregnant_followup->plan_date : '' }}">
							</div>
						</div>
						<div class="form-group row" >
							<div class="col-md-8">
...
<div class="ibox float-e-margins ">
	...
	<div class="ibox-content">
		<div class="form-group">
			<label for="">Super Cereal Plus WSB++ (kg)</label>
			<input type="number" name="wsb_plus_plus_kg" class="form-control" placeholder="Super Cereal Plus WSB++ (kg)" value="{{ isset($facility_followup) ? $facility_followup->wsb_plus_plus_kg : '' }}" min="0">
		</div>
		<div class="form-group">
			<label for="">Super Cereal WSB+ (kg)</label>
			<input type="number" name="wsb_plus_kg" class="form-control" placeholder="Super Cereal WSB+ (kg)" value="{{ isset($facility_followup) ? $facility_followup->wsb_plus_kg : '' }}" min="0">
		</div>
		<div class="form-group">
