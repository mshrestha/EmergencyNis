...
{{--                                    <strong>{{ date('F', mktime(0, 0, 0, $current_month, 10)).'-'.$current_year }}</strong>--}}
                        ...
                        <table
                            ...
                            <tr class="gradeX">
                                ...
                                <td>{{$report_male_6to23['new_admission_oedema']}}</td>
                                <td>{{$report_female_6to23['new_admission_oedema']}}</td>
                                ...
                                <td>{{$report_male_6to23['transfer_in_from_sc']}}</td>
                                <td>{{$report_female_6to23['transfer_in_from_sc']}}</td>
                                ...
                                <td>{{$report_female_6to23['discharge_criteria_exit_recovered']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_exit_defaulted']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_defaulted']}}</td>
                                ...
                                <td>{{$report_male_6to23['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_transfer_out_sc']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_transfer_out_sc']}}</td>
                            ...
                            <tr class="gradeX">
                                ...
                                <td>{{$report_male_24to59['new_admission_oedema']}}</td>
                                <td>{{$report_female_24to59['new_admission_oedema']}}</td>
                                ...
                                <td>{{$report_male_24to59['transfer_in_from_sc']}}</td>
                                <td>{{$report_female_24to59['transfer_in_from_sc']}}</td>
                                ...
                                <td>{{$report_female_24to59['discharge_criteria_exit_recovered']}}</td>
                                <td>{{$report_male_24to59['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_female_24to59['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_male_24to59['discharge_criteria_exit_defaulted']}}</td>
                                <td>{{$report_female_24to59['discharge_criteria_exit_defaulted']}}</td>
                                ...
                                <td>{{$report_male_24to59['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_female_24to59['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_male_24to59['discharge_criteria_transfer_out_sc']}}</td>
                                <td>{{$report_female_24to59['discharge_criteria_transfer_out_sc']}}</td>
                            ...
                            <tr class="gradeX" style="background-color: #b8daff">
                                <td>Total</td>
                                <td style="background-color: #FCDDAE">{{$report_male_6to23['begining_balance_total_enrolled']+$report_male_24to59['begining_balance_total_enrolled']+$report_male_60up['begining_balance_total_enrolled']}}</td>
                                <td style="background-color: #FCDDAE">{{$report_female_6to23['begining_balance_total_enrolled']+$report_female_24to59['begining_balance_total_enrolled']+$report_female_60up['begining_balance_total_enrolled']}}</td>
                                <td style="background-color: #FCDDAE">{{$report_male_6to23['begining_balance_total_enrolled']+$report_male_24to59['begining_balance_total_enrolled']+$report_male_60up['begining_balance_total_enrolled']+$report_female_6to23['begining_balance_total_enrolled']+$report_female_24to59['begining_balance_total_enrolled']+$report_female_60up['begining_balance_total_enrolled']}}</td>

                                <td>{{$report_male_6to23['new_admission_muac']+$report_male_24to59['new_admission_muac']+$report_male_60up['new_admission_muac']}}</td>
                                <td>{{$report_female_6to23['new_admission_muac']+$report_female_24to59['new_admission_muac']+$report_female_60up['new_admission_muac']}}</td>
                                <td>{{$report_male_6to23['new_admission_zscore']+$report_male_24to59['new_admission_zscore']+$report_male_60up['new_admission_zscore']}}</td>
                                <td>{{$report_female_6to23['new_admission_zscore']+$report_female_24to59['new_admission_zscore']+$report_female_60up['new_admission_zscore']}}</td>
                                <td>{{$report_male_6to23['new_admission_oedema']+$report_male_24to59['new_admission_oedema']+$report_male_60up['new_admission_oedema']}}</td>
                                <td>{{$report_female_6to23['new_admission_oedema']+$report_female_24to59['new_admission_oedema']+$report_female_60up['new_admission_oedema']}}</td>
                                <td>{{$report_male_6to23['new_admission_relapse']+$report_male_24to59['new_admission_relapse']+$report_male_60up['new_admission_relapse']}}</td>
                                <td>{{$report_female_6to23['new_admission_relapse']+$report_female_24to59['new_admission_relapse']+$report_female_60up['new_admission_relapse']}}</td>

                                <td style="background-color: #F6FCCD">{{$report_male_6to23['new_admission_total']+$report_male_24to59['new_admission_total']+$report_male_60up['new_admission_total']}}</td>
                                <td style="background-color: #F6FCCD">{{$report_female_6to23['new_admission_total']+$report_female_24to59['new_admission_total']+$report_female_60up['new_admission_total']}}</td>
                                <td style="background-color: #F6FCCD">{{$report_male_6to23['new_admission_total']+$report_male_24to59['new_admission_total']+$report_male_60up['new_admission_total']+$report_female_6to23['new_admission_total']+$report_female_24to59['new_admission_total']+$report_female_60up['new_admission_total']}}</td>

                                <td>{{$report_male_6to23['readmission_after_default']+$report_male_24to59['readmission_after_default']+$report_male_60up['readmission_after_default']}}</td>
                                <td>{{$report_female_6to23['readmission_after_default']+$report_female_24to59['readmission_after_default']+$report_female_60up['readmission_after_default']}}</td>
                                <td>{{$report_male_6to23['transfer_in_from_tsfp']+$report_male_24to59['transfer_in_from_tsfp']+$report_male_60up['transfer_in_from_tsfp']}}</td>
                                <td>{{$report_female_6to23['transfer_in_from_tsfp']+$report_female_24to59['transfer_in_from_tsfp']+$report_female_60up['transfer_in_from_tsfp']}}</td>
                                <td>{{$report_male_6to23['transfer_in_from_sc']+$report_male_24to59['transfer_in_from_sc']+$report_male_60up['transfer_in_from_sc']}}</td>
                                <td>{{$report_female_6to23['transfer_in_from_sc']+$report_female_24to59['transfer_in_from_sc']+$report_female_60up['transfer_in_from_sc']}}</td>
                                <td>{{$report_male_6to23['transfer_in_from_otp']+$report_male_24to59['transfer_in_from_otp']+$report_male_60up['transfer_in_from_otp']}}</td>
                                <td>{{$report_female_6to23['transfer_in_from_otp']+$report_female_24to59['transfer_in_from_otp']+$report_female_60up['transfer_in_from_otp']}}</td>

                                <td style="background-color: #F6FCCD">{{$report_male_6to23['transfer_in_total']+$report_male_24to59['transfer_in_total']+$report_male_60up['transfer_in_total']}}</td>
                                <td style="background-color: #F6FCCD">{{$report_female_6to23['transfer_in_total']+$report_female_24to59['transfer_in_total']+$report_female_60up['transfer_in_total']}}</td>
                                <td style="background-color: #F6FCCD">{{$report_male_6to23['transfer_in_total']+$report_male_24to59['transfer_in_total']+$report_male_60up['transfer_in_total']+$report_female_6to23['transfer_in_total']+$report_female_24to59['transfer_in_total']+$report_female_60up['transfer_in_total']}}</td>

                                <td style="background-color: #D9FB9C">{{$report_male_6to23['enrollment_total']+$report_male_24to59['enrollment_total']+$report_male_60up['enrollment_total']}}</td>
                                <td style="background-color: #D9FB9C">{{$report_female_6to23['enrollment_total']+$report_female_24to59['enrollment_total']+$report_female_60up['enrollment_total']}}</td>
                                <td style="background-color: #D9FB9C">{{$report_male_6to23['enrollment_total']+$report_male_24to59['enrollment_total']+$report_male_60up['enrollment_total']+$report_female_6to23['enrollment_total']+$report_female_24to59['enrollment_total']+$report_female_60up['enrollment_total']}}</td>

                                <td>{{$report_male_6to23['discharge_criteria_exit_recovered']+$report_male_24to59['discharge_criteria_exit_recovered']+$report_male_60up['discharge_criteria_exit_recovered']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_recovered']+$report_female_24to59['discharge_criteria_exit_recovered']+$report_female_60up['discharge_criteria_exit_recovered']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_exit_death']+$report_male_24to59['discharge_criteria_exit_death']+$report_male_60up['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_death']+$report_female_24to59['discharge_criteria_exit_death']+$report_female_60up['discharge_criteria_exit_death']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_exit_defaulted']+$report_male_24to59['discharge_criteria_exit_defaulted']+$report_male_60up['discharge_criteria_exit_defaulted']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_defaulted']+$report_female_24to59['discharge_criteria_exit_defaulted']+$report_female_60up['discharge_criteria_exit_defaulted']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_exit_nonrecovered']+$report_male_24to59['discharge_criteria_exit_nonrecovered']+$report_male_60up['discharge_criteria_exit_nonrecovered']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_exit_nonrecovered']+$report_female_24to59['discharge_criteria_exit_nonrecovered']+$report_female_60up['discharge_criteria_exit_nonrecovered']}}</td>

                                <td style="background-color: #CDECFC">{{$report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']}}</td>
                                <td style="background-color: #CDECFC">{{$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']}}</td>
                                <td style="background-color: #CDECFC">{{$report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']}}</td>

                                <td>{{$report_male_6to23['discharge_criteria_others_medical_transfer']+$report_male_24to59['discharge_criteria_others_medical_transfer']+$report_male_60up['discharge_criteria_others_medical_transfer']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_others_medical_transfer']+$report_female_24to59['discharge_criteria_others_medical_transfer']+$report_female_60up['discharge_criteria_others_medical_transfer']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_others_unkown']+$report_male_24to59['discharge_criteria_others_unkown']+$report_male_60up['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_others_unkown']+$report_female_24to59['discharge_criteria_others_unkown']+$report_female_60up['discharge_criteria_others_unkown']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_transfer_out_sc']+$report_male_24to59['discharge_criteria_transfer_out_sc']+$report_male_60up['discharge_criteria_transfer_out_sc']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_transfer_out_sc']+$report_female_24to59['discharge_criteria_transfer_out_sc']+$report_female_60up['discharge_criteria_transfer_out_sc']}}</td>
                                <td>{{$report_male_6to23['discharge_criteria_transfer_out_otp']+$report_male_24to59['discharge_criteria_transfer_out_otp']+$report_male_60up['discharge_criteria_transfer_out_otp']}}</td>
                                <td>{{$report_female_6to23['discharge_criteria_transfer_out_otp']+$report_female_24to59['discharge_criteria_transfer_out_otp']+$report_female_60up['discharge_criteria_transfer_out_otp']}}</td>

                                <td style="background-color: #CDECFC">{{$report_male_6to23['exit_total']+$report_male_24to59['exit_total']+$report_male_60up['exit_total']}}</td>
                                <td style="background-color: #CDECFC">{{$report_female_6to23['exit_total']+$report_female_24to59['exit_total']+$report_female_60up['exit_total']}}</td>
                                <td style="background-color: #CDECFC">{{$report_male_6to23['exit_total']+$report_male_24to59['exit_total']+$report_male_60up['exit_total']+$report_female_6to23['exit_total']+$report_female_24to59['exit_total']+$report_female_60up['exit_total']}}</td>

                                <td>{{$report_male_6to23['end_of_month']+$report_male_24to59['end_of_month']+$report_male_60up['end_of_month']}}</td>
                                <td>{{$report_female_6to23['end_of_month']+$report_female_24to59['end_of_month']+$report_female_60up['end_of_month']}}</td>
                                <td>{{$report_male_6to23['end_of_month']+$report_male_24to59['end_of_month']+$report_male_60up['end_of_month']+$report_female_6to23['end_of_month']+$report_female_24to59['end_of_month']+$report_female_60up['end_of_month']}}</td>
                            </tr>
                            <tr style="background-color: #dff0d8">
                                <td colspan="29">Performance</td>
                                <td colspan="2">{{(($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total'])==0)?'0%':((($report_male_6to23['discharge_criteria_exit_recovered']+$report_male_24to59['discharge_criteria_exit_recovered']+$report_male_60up['discharge_criteria_exit_recovered']+$report_female_6to23['discharge_criteria_exit_recovered']+$report_female_24to59['discharge_criteria_exit_recovered']+$report_female_60up['discharge_criteria_exit_recovered'])/($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']))*100).'%'}}</td>
                                <td colspan="2">{{(($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total'])==0)?'0%':((($report_male_6to23['discharge_criteria_exit_death']+$report_male_24to59['discharge_criteria_exit_death']+$report_male_60up['discharge_criteria_exit_death']+$report_female_6to23['discharge_criteria_exit_death']+$report_female_24to59['discharge_criteria_exit_death']+$report_female_60up['discharge_criteria_exit_death'])/($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']))*100).'%'}}</td>
                                <td colspan="2">{{(($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total'])==0)?'0%':((($report_male_6to23['discharge_criteria_exit_defaulted']+$report_male_24to59['discharge_criteria_exit_defaulted']+$report_male_60up['discharge_criteria_exit_defaulted']+$report_female_6to23['discharge_criteria_exit_defaulted']+$report_female_24to59['discharge_criteria_exit_defaulted']+$report_female_60up['discharge_criteria_exit_defaulted'])/($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']))*100).'%'}}</td>
                                <td colspan="2">{{(($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total'])==0)?'0%':((($report_male_6to23['discharge_criteria_exit_nonrecovered']+$report_male_24to59['discharge_criteria_exit_nonrecovered']+$report_male_60up['discharge_criteria_exit_nonrecovered']+$report_female_6to23['discharge_criteria_exit_nonrecovered']+$report_female_24to59['discharge_criteria_exit_nonrecovered']+$report_female_60up['discharge_criteria_exit_nonrecovered'])/($report_male_6to23['discharge_criteria_exit_total']+$report_male_24to59['discharge_criteria_exit_total']+$report_male_60up['discharge_criteria_exit_total']+$report_female_6to23['discharge_criteria_exit_total']+$report_female_24to59['discharge_criteria_exit_total']+$report_female_60up['discharge_criteria_exit_total']))*100).'%'}}</td>
                                <td colspan="17"></td>
                            </tr>
                            </tbody>
