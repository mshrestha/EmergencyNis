        ...
        <div class="col-lg-6">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form style="margin-top: 15px;padding: 10px;" action="{{ URL::to('importBsfp') }}"
                            ...
                            <table class="table dataTables table-striped table-bordered table-hover">
                                ...
                                @foreach($generated_data as $data)
                                    <tr>
                                        ...
                                        <td>Imported</td>
                                        <td>
                                            <form action="{{ route('importExportBsfp.destroy',$data->year.'_'.$data->month) }}" method="POST" >
                                                @csrf
                                                @method('DELETE')
